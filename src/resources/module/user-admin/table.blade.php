    ...
    <td class="text-end">
        <div class="btn-group">
            ...
            <ul class="dropdown-menu dropdown-menu-end dropdown-action">
                <li>
                    <a href="{{adminRoute('admin.user-admin.edit',$row->uuid)}}" class="dropdown-item">Edit</a>
                </li>
                <li>
                    <a href="javascript:;" data-toggle="confirmation"
                        data-message="{{__('adminportal.delete_confirmation')}}"
                        data-action="{{adminRoute('admin.user-admin.destroy',$row->uuid)}}" data-method="DELETE"
